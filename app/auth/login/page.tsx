...
const S = {
  ...
  ok:    { padding:"12px 14px", background:"#0a9e6e12", border:"1px solid #0a9e6e30", borderRadius:10, color:"#0a9e6e", fontSize:13, marginBottom:18 } as React.CSSProperties,
          ...
          <div style={{ marginBottom:8 }}>
            ...
            <div style={{ position:"relative" }}>
              ...
              <button type="button" onClick={() => setShowPw(s => !s)}
                style={{ position:"absolute", right:12, top:"50%", transform:"translateY(-50%)", background:"none", border:"none", cursor:"pointer", color:"#6b7f99", fontSize:12, padding:4 }}>
